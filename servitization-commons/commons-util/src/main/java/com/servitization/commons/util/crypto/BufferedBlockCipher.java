package com.servitization.commons.util.crypto;
...
public class BufferedBlockCipher {
     ...
     * @return the number of output bytes copied to out.
     * @throws DataLengthException   if there is insufficient space in out for the output, or
     ...
     * @throws DataLengthException   if the input is not block size aligned.
     */
