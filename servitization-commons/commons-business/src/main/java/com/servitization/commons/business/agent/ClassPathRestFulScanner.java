...
public class ClassPathRestFulScanner extends ClassPathBeanDefinitionScanner {
    ...
    public ClassPathRestFulScanner(BeanDefinitionRegistry registry) {
    ...
    protected boolean checkCandidate(String beanName, BeanDefinition beanDefinition) throws IllegalStateException {
        if (super.checkCandidate(beanName, beanDefinition)) {
            ...
            logger.warn("Skipping AgentFactoryBean with name '" + beanName
                    + "' and '" + beanDefinition.getBeanClassName() + "' agentInterface"
