...
public class MachineController {
    ...
    public ModelAndView getMachineListByMtdtId(HttpServletRequest request) {
    ...
    public ResponseEntity<byte[]> addMetadataMachine(HttpServletRequest request) {
        String metadataId = request.getParameter("metadataId");
        String ip = request.getParameter("ip");
        String status = request.getParameter("status");
        String metadataDescription = request.getParameter("metadataDescription");
        if (StringUtils.isBlank(metadataId)) {
            return new ResponseEntity<>("metadataId is Blank".getBytes(), HttpStatus.OK);
        }
        if (StringUtils.isBlank(ip)) {
            return new ResponseEntity<>("ip is Blank".getBytes(), HttpStatus.OK);
        }
    ...
    public ResponseEntity<byte[]> deleteMetadataMachine(HttpServletRequest request) {
