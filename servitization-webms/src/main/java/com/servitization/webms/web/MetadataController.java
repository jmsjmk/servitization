...
public class MetadataController {
    ...
    public ResponseEntity<byte[]> deleteMetadatas(HttpServletRequest request, HttpServletResponse response) {
    ...
    public ResponseEntity<byte[]> addMetadata(HttpServletRequest request, HttpServletResponse response) {
        String msg = "添加成功";
    ...
    public ResponseEntity<byte[]> addMetadataByCopy(HttpServletRequest request, HttpServletResponse response) {
        String msg = "复制添加成功";
    ...
    public ResponseEntity<byte[]> updateMetadataChain(HttpServletRequest request, HttpServletResponse response) {
        String metadataId = request.getParameter("metadataId");
        ...
        if (!upFlag) {
            return new ResponseEntity<byte[]>("上行链条有重复模块,请重新选择".getBytes(), HttpStatus.OK);
        }

        if (!downFlag) {
            return new ResponseEntity<byte[]>("下行链条有重复模块,请重新选择".getBytes(), HttpStatus.OK);
        }
