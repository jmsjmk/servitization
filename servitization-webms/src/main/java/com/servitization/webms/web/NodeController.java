...
public class NodeController extends BaseObserver {
    ...
    public ModelAndView getNodePage(HttpServletRequest request) {
    ...
    public ModelAndView getNodePageNew(HttpServletRequest request) {
        ModelAndView mav = new ModelAndView();
        Map<String, Object> modelMap = new HashMap<>();
    ...
    public ResponseEntity<byte[]> delNode(HttpServletRequest request) {
        String msg = "删除成功";
    ...
    public ResponseEntity<byte[]> addNodes(HttpServletRequest request) {
