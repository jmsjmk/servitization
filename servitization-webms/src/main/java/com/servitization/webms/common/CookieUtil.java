...
public class CookieUtil {
    ...
    // cookie默认生命周期是一个月.单位为秒
    private final static int DEFAUL_COOKIE_MAXAGE = 30 * 24 * 60 * 60;

    private CookieUtil() {

    }

    public static void saveUserCookieToLocale(HttpServletResponse response, int maxAge,
